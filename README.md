...
If SIF ever has any intention of establishing a minute data backend in the future, please feel free to reach out to us even if we don't end up getting in. We would be happy to collaborate and would hopefully give you guys a starting point instead of having to start from scratch, and we are hoping to add things like volume, more equities, and possibly options chains. The email for Stocket is stocketapi@gmail.com and my personal email is bhoulton@terpmail.umd.edu.
